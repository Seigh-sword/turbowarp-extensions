      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            ...
            arguments: { NAME: { type: Scratch.ArgumentType.STRING, defaultValue: "TurboBot" } }
          },
          {
            opcode: "renameBot",
            blockType: Scratch.BlockType.COMMAND,
          ...
          },
          {
            opcode: "importBot",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("import conversation [TEXT] as [TYPE] to bot [NAME]"),
            arguments: {
          ...
          "---",
          {
            ...
            arguments: { MOD: { type: Scratch.ArgumentType.STRING, menu: "textMenu" } }
          },
          {
            opcode: "setImageModel",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set image model [MOD]"),
            arguments: { MOD: { type: Scratch.ArgumentType.STRING, menu: "imageMenu" } }
          },
          "---",
          {
            opcode: "setImageSize",
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set image from prompt [TEXT] as SVG costume named [NAME]"),
            arguments: {
          ...
          },
          {
            ...
            arguments: { TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: "a racecar" } }
          },
          {
            opcode: "attachFile",
            blockType: Scratch.BlockType.COMMAND,
...

          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("set text context [CTX] and generate image url for [TEXT]"),
            arguments: {
              CTX: { type: Scratch.ArgumentType.STRING, defaultValue: "Pixel Art" },
              TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: "a dragon" }
            }
          },
          
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set text context [CTX] and generate image [TEXT] as costume named [NAME]"),
            arguments: {
              CTX: { type: Scratch.ArgumentType.STRING, defaultValue: "Cyberpunk" },
              TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: "a car" },
              NAME: { type: Scratch.ArgumentType.STRING, defaultValue: "AI_Costume" }
            }
          },
          "---",
          {
            ...
            arguments: { LOG: { type: Scratch.ArgumentType.STRING, defaultValue: "You are a helpful assistant." } }
          },
          {
            opcode: "setTemp",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set temperature [N]"),
            arguments: { N: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1.0 } }
          },
          {
            opcode: "setSeed",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("set seed [N]"),
            arguments: { N: { type: Scratch.ArgumentType.NUMBER, defaultValue: 12345 } }
          },
